    ...
    <div className="w-full min-h-screen bg-white text-gray-800">
      ...
      <section className="relative w-full h-[70vh] min-h-[450px] flex flex-col justify-center items-center text-center bg-stone-100 bg-cover bg-center px-4" style={{ backgroundImage: "url('/images/hero-bg.jpg')" }}>
        ...
        <div className="relative z-10 space-y-4">
          <h1 className="text-4xl md:text-6xl font-black tracking-widest uppercase text-gray-900 notranslate" translate="no">
            PALGIVES
          </h1>
          <div className="w-32 md:w-56 h-1 bg-yellow-400 my-4 mx-auto rounded-full"></div>
          <button className="mt-4 px-8 py-2.5 border-2 border-gray-900 text-gray-900 font-semibold uppercase tracking-wider text-xs md:text-sm hover:bg-gray-900 hover:text-white transition-all duration-200 shadow-sm cursor-pointer">
            <T>Donate now</T>
          </button>
        </div>
      </section>
